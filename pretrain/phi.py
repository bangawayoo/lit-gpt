...
micro_batch_size = 2
num_epochs = 3
max_tokens = int(1639 * 2048 * 1024 * num_epochs) # 1639 chunks * 2048 tokens * 1024 samples * num_epochs
warmup_steps = 1000
log_step_interval = 1
eval_iters = 100
...
def setup(resume: Union[bool, Path] = False):
    ...
    fabric = L.Fabric(devices=devices, strategy="ddp", precision="bf16-true", loggers=[logger])
    fabric.launch()
